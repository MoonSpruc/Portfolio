(() => {
    ...
    if (document.querySelector(".projects__slider")) new Swiper(".projects__slider", {
        modules: [ Navigation ],
        observer: true,
        observeParents: true,
        slidesPerView: 1,
    ...
    let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
        ...
        if (targetBlockElement) {
            ...
            if (noHeader) {
                ...
                headerElement.querySelector(".header__container");
        ...
        function pageNavigationAction(e) {
            if (e.type === "click") {
                ...
                if (targetElement.closest("[data-goto]")) {
                    ...
                    if (andModules.fullpage) {
                        const fullpageSection = document.querySelector(`${gotoLinkSelector}`).closest("[data-fp-section]");
                        const fullpageSectionId = fullpageSection ? +fullpageSection.dataset.fpId : null;
                        if (fullpageSectionId !== null) {
                            andModules.fullpage.switchingSection(fullpageSectionId);
                            document.documentElement.classList.contains("menu-open") ? menuClose() : null;
                        }
    ...
    class ScrollWatcher {
        ...
        getScrollWatcherConfig(paramsWatch) {
            let configWatcher = {};
            if (document.querySelector(paramsWatch.root)) configWatcher.root = document.querySelector(paramsWatch.root); else if (paramsWatch.root !== "null") alert(`Эмм... родительского объекта ${paramsWatch.root} нет на странице`);
    ...
    andModules.watcher = new ScrollWatcher({});
    isWebp();
    addLoadedClass();
    menuInit();
    pageNavigation();
